...
import { DiagramEngine, LinkWidget, PointModel, LinkModel } from '@projectstorm/react-diagrams-core';
import { MouseEvent } from 'react';
import { SpendLinkModel } from "./SpendLinkModel";
import { DefaultLinkWidget, DefaultLinkFactory } from '@projectstorm/react-diagrams';
...
export class SpendLinkWidget extends DefaultLinkWidget {
    generateLink(path: string, extraProps: any, id: string | number): JSX.Element {
		...
		var Bottom = React.cloneElement(
			...
			{
				ref: (ref: React.RefObject<SVGPathElement> | null) => ref && this.refPaths.push(ref)
			}
		);
