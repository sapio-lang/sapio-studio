                        ...
                        fields: [
                            {
                                ...
                                type: 'file',
                                help:
                                    'The sapio-cli binary to use. Release build highly recommended for performance',
                                dontAddToRecent: true,
                            },
                            {
                                label: 'Preferences From',
                                help:
                                    'Where should sapio-cli read preferences from',
                                key: 'configsource',
                                type: 'radio',
                                options: [
                            ...
                            },
                            {
                                ...
                                type: 'file',
                                help:
                                    'If specified, to use the default file or one selected here.',
                                dontAddToRecent: true,
                            },
                            {
                        ...
                        fields: [
                            {
                                ...
                                help:
                                    'Run a local oracle on startup when checked.',
                            ...
                            },
                            {
                                label: 'Seed File',
                                help:
                                    'The file containing the seed for this oracle. If you do not have one, try ' +
                            ...
                            },
                            {
                                ...
                                help:
                                    'What interface to bind (e.g. 0.0.0.0:8080)',
                        ...
                        fields: [
                            {
                                ...
                                help:
                                    'Should compilation target OP_CHECKTEMPLATEVERIFY or Oracle Emultation',
                            },
                            {
                ...
                groups: [
                    ...
                    },
                    {
                        ...
                        fields: [
                            {
                                label:
                                    'Coin Flow Animation Speed in milliseconds (0 to disable)',
                                key: 'animate-flow',
                                type: 'slider',
                                min: 0,
                                max: 5000,
...
export const custom_sapio_config = () => {
    ...
    const oracle_list = settings
        ...
        .map((line: string) => {
            ...
            if (opts.length != 2) {
                dialog.showErrorBox(
                    'Setting Error:',
                    'Improperly Formatted Setting for Sapio Oracle List ' + line
                );
                error = true;
                return;
            }
    ...
    settings.value('sapio.plugin_map').forEach((line: string) => {
        ...
        if (opts.length != 2) {
            dialog.showErrorBox(
                'Setting Error:',
                'Improperly Formatted Setting for Sapio Plugin Map' + line
            );
            error = true;
            return;
        }
