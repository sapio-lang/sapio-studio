...
The artifacts and two WASM modules are generated from Sapio revision
`b6a03c452463a3500dd0d84f3b853d9bc78ef68c` with Rust 1.98.1. `modules.json` records
...
`starter-artifact.json` and `starter-explanation.json` come from `sapio-cli new`
